...
mixin _$Advance {
 ...
 String get id; String get tripId; int get amount; AdvancePurpose get purpose; String? get note; AdvanceStatus get status; DateTime get requestedAt;
...
int get hashCode {
  final _this = this as Advance;
  return Object.hash(runtimeType,_this.id,_this.tripId,_this.amount,_this.purpose,_this.note,_this.status,_this.requestedAt);
}
...
@useResult
$Res call({
 String id, String tripId, int amount, AdvancePurpose purpose, String? note, AdvanceStatus status, DateTime requestedAt
});
...
/// Create a copy of Advance
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? tripId = null,Object? amount = null,Object? purpose = null,Object? note = freezed,Object? status = null,Object? requestedAt = null,}) {
...
as AdvancePurpose,note: freezed == note ? _self.note : note // ignore: cast_nullable_to_non_nullable
as String?,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as AdvanceStatus,requestedAt: null == requestedAt ? _self.requestedAt : requestedAt // ignore: cast_nullable_to_non_nullable
as DateTime,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String tripId,  int amount,  AdvancePurpose purpose,  String? note,  AdvanceStatus status,  DateTime requestedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Advance() when $default != null:
return $default(_that.id,_that.tripId,_that.amount,_that.purpose,_that.note,_that.status,_that.requestedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String tripId,  int amount,  AdvancePurpose purpose,  String? note,  AdvanceStatus status,  DateTime requestedAt)  $default,) {final _that = this;
switch (_that) {
case _Advance():
return $default(_that.id,_that.tripId,_that.amount,_that.purpose,_that.note,_that.status,_that.requestedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String tripId,  int amount,  AdvancePurpose purpose,  String? note,  AdvanceStatus status,  DateTime requestedAt)?  $default,) {final _that = this;
switch (_that) {
case _Advance() when $default != null:
return $default(_that.id,_that.tripId,_that.amount,_that.purpose,_that.note,_that.status,_that.requestedAt);case _:
  return null;
...
class _Advance implements Advance {
  const _Advance({required this.id, required this.tripId, required this.amount, required this.purpose, this.note, this.status = AdvanceStatus.requested, required this.requestedAt});
  factory _Advance.fromJson(Map<String, dynamic> json) => _$AdvanceFromJson(json);

@override final  String id;
@override final  String tripId;
@override final  int amount;
@override final  AdvancePurpose purpose;
@override final  String? note;
@override@JsonKey() final  AdvanceStatus status;
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,tripId,amount,purpose,note,status,requestedAt);
}
...
/// Create a copy of Advance
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? tripId = null,Object? amount = null,Object? purpose = null,Object? note = freezed,Object? status = null,Object? requestedAt = null,}) {
