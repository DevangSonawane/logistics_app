...
mixin _$CustomerContact {
 ...
 String get name; String get phone; String? get role;
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CustomerContact&&(identical(other.name, _this.name) || other.name == _this.name)&&(identical(other.phone, _this.phone) || other.phone == _this.phone)&&(identical(other.role, _this.role) || other.role == _this.role));
}
...
/// Create a copy of CustomerContact
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? phone = null,Object? role = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String phone,  String? role)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CustomerContact() when $default != null:
return $default(_that.name,_that.phone,_that.role);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String phone,  String? role)  $default,) {final _that = this;
switch (_that) {
case _CustomerContact():
return $default(_that.name,_that.phone,_that.role);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String phone,  String? role)?  $default,) {final _that = this;
switch (_that) {
case _CustomerContact() when $default != null:
return $default(_that.name,_that.phone,_that.role);case _:
  return null;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _CustomerContact&&(identical(other.name, name) || other.name == name)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.role, role) || other.role == role));
}
...
/// Create a copy of CustomerContact
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? phone = null,Object? role = freezed,}) {
...
mixin _$Customer {
 ...
 String get id; String get name; String get gstin; String? get pan; int get creditDays; int get creditLimit; int get outstanding; List<CustomerContact> get contacts;
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Customer&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.name, _this.name) || other.name == _this.name)&&(identical(other.gstin, _this.gstin) || other.gstin == _this.gstin)&&(identical(other.pan, _this.pan) || other.pan == _this.pan)&&(identical(other.creditDays, _this.creditDays) || other.creditDays == _this.creditDays)&&(identical(other.creditLimit, _this.creditLimit) || other.creditLimit == _this.creditLimit)&&(identical(other.outstanding, _this.outstanding) || other.outstanding == _this.outstanding)&&const DeepCollectionEquality().equals(other.contacts, _this.contacts));
}
...
int get hashCode {
  final _this = this as Customer;
  return Object.hash(runtimeType,_this.id,_this.name,_this.gstin,_this.pan,_this.creditDays,_this.creditLimit,_this.outstanding,const DeepCollectionEquality().hash(_this.contacts));
}
...
@useResult
$Res call({
 String id, String name, String gstin, String? pan, int creditDays, int creditLimit, int outstanding, List<CustomerContact> contacts
});
...
/// Create a copy of Customer
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? gstin = null,Object? pan = freezed,Object? creditDays = null,Object? creditLimit = null,Object? outstanding = null,Object? contacts = null,}) {
...
as int,creditLimit: null == creditLimit ? _self.creditLimit : creditLimit // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String gstin,  String? pan,  int creditDays,  int creditLimit,  int outstanding,  List<CustomerContact> contacts)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Customer() when $default != null:
return $default(_that.id,_that.name,_that.gstin,_that.pan,_that.creditDays,_that.creditLimit,_that.outstanding,_that.contacts);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String gstin,  String? pan,  int creditDays,  int creditLimit,  int outstanding,  List<CustomerContact> contacts)  $default,) {final _that = this;
switch (_that) {
case _Customer():
return $default(_that.id,_that.name,_that.gstin,_that.pan,_that.creditDays,_that.creditLimit,_that.outstanding,_that.contacts);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String gstin,  String? pan,  int creditDays,  int creditLimit,  int outstanding,  List<CustomerContact> contacts)?  $default,) {final _that = this;
switch (_that) {
case _Customer() when $default != null:
return $default(_that.id,_that.name,_that.gstin,_that.pan,_that.creditDays,_that.creditLimit,_that.outstanding,_that.contacts);case _:
  return null;
...
class _Customer implements Customer {
  const _Customer({required this.id, required this.name, required this.gstin, this.pan, this.creditDays = 30, this.creditLimit = 0, this.outstanding = 0,  List<CustomerContact> contacts = const []}): _contacts = contacts;
...
@override@JsonKey() final  int creditDays;
...
/// Create a copy of Customer
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? gstin = null,Object? pan = freezed,Object? creditDays = null,Object? creditLimit = null,Object? outstanding = null,Object? contacts = null,}) {
...
as int,creditLimit: null == creditLimit ? _self.creditLimit : creditLimit // ignore: cast_nullable_to_non_nullable
as int,outstanding: null == outstanding ? _self.outstanding : outstanding // ignore: cast_nullable_to_non_nullable
as int,contacts: null == contacts ? _self._contacts : contacts // ignore: cast_nullable_to_non_nullable
as List<CustomerContact>,
  ));
}
