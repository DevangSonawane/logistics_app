...
mixin _$HubTask {
  String get id;
  HubTaskType get type;
  String get vehicleNo;
  String get customer;
  DateTime? get eta;
  HubTaskStatus get status;
  DateTime? get gateInAt;
  DateTime? get gateOutAt;
  String? get sealNo;
  double? get weighmentKg;
  double? get declaredKg;
  int get expectedPackages;

  /// Create a copy of HubTask
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $HubTaskCopyWith<HubTask> get copyWith =>
      _$HubTaskCopyWithImpl<HubTask>(this as HubTask, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.customer, _this.customer) ||
                other.customer == _this.customer) &&
            (identical(other.eta, _this.eta) || other.eta == _this.eta) &&
            (identical(other.status, _this.status) ||
                other.status == _this.status) &&
            (identical(other.gateInAt, _this.gateInAt) ||
                other.gateInAt == _this.gateInAt) &&
            (identical(other.gateOutAt, _this.gateOutAt) ||
                other.gateOutAt == _this.gateOutAt) &&
            (identical(other.sealNo, _this.sealNo) ||
                other.sealNo == _this.sealNo) &&
            (identical(other.weighmentKg, _this.weighmentKg) ||
                other.weighmentKg == _this.weighmentKg) &&
            (identical(other.declaredKg, _this.declaredKg) ||
                other.declaredKg == _this.declaredKg) &&
            (identical(other.expectedPackages, _this.expectedPackages) ||
                other.expectedPackages == _this.expectedPackages));
  }
...
abstract mixin class $HubTaskCopyWith<$Res> {
  factory $HubTaskCopyWith(HubTask value, $Res Function(HubTask) _then) =
      _$HubTaskCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      HubTaskType type,
...
/// @nodoc
class _$HubTaskCopyWithImpl<$Res> implements $HubTaskCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? eta = freezed,
    Object? status = null,
    Object? gateInAt = freezed,
    Object? gateOutAt = freezed,
    Object? sealNo = freezed,
    Object? weighmentKg = freezed,
    Object? declaredKg = freezed,
    Object? expectedPackages = null,
  }) {
    return _then(HubTask(
      ...
      status: null == status
          ...
          : status // ignore: cast_nullable_to_non_nullable
              as HubTaskStatus,
      gateInAt: freezed == gateInAt
          ? _self.gateInAt
          : gateInAt // ignore: cast_nullable_to_non_nullable
              as DateTime?,
      gateOutAt: freezed == gateOutAt
          ? _self.gateOutAt
          : gateOutAt // ignore: cast_nullable_to_non_nullable
              as DateTime?,
      sealNo: freezed == sealNo
          ? _self.sealNo
          : sealNo // ignore: cast_nullable_to_non_nullable
              as String?,
      weighmentKg: freezed == weighmentKg
          ? _self.weighmentKg
          : weighmentKg // ignore: cast_nullable_to_non_nullable
              as double?,
      declaredKg: freezed == declaredKg
          ? _self.declaredKg
          : declaredKg // ignore: cast_nullable_to_non_nullable
              as double?,
      expectedPackages: null == expectedPackages
          ? _self.expectedPackages
          : expectedPackages // ignore: cast_nullable_to_non_nullable
              as int,
    ));
  }
}
...
extension HubTaskPatterns on HubTask {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_HubTask value)? $default, {
...
class _HubTask implements HubTask {
  const _HubTask(
      ...
      this.eta,
      this.status = HubTaskStatus.pending,
      this.gateInAt,
      this.gateOutAt,
      this.sealNo,
      this.weighmentKg,
  ...
  factory _HubTask.fromJson(Map<String, dynamic> json) =>
      _$HubTaskFromJson(json);

  @override
  final String id;
  @override
  final HubTaskType type;
  @override
  ...
  @override
  @JsonKey()
  final HubTaskStatus status;
  @override
  final DateTime? gateInAt;
  @override
  final DateTime? gateOutAt;
  @override
  final String? sealNo;
  @override
  final double? weighmentKg;
  @override
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$HubTaskCopyWith<_HubTask> get copyWith =>
      __$HubTaskCopyWithImpl<_HubTask>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$HubTaskToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.gateInAt, gateInAt) ||
                other.gateInAt == gateInAt) &&
            (identical(other.gateOutAt, gateOutAt) ||
                other.gateOutAt == gateOutAt) &&
            (identical(other.sealNo, sealNo) || other.sealNo == sealNo) &&
            (identical(other.weighmentKg, weighmentKg) ||
                other.weighmentKg == weighmentKg) &&
            (identical(other.declaredKg, declaredKg) ||
                other.declaredKg == declaredKg) &&
            (identical(other.expectedPackages, expectedPackages) ||
                other.expectedPackages == expectedPackages));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode {
    return Object.hash(runtimeType, id, type, vehicleNo, customer, eta, status,
        gateInAt, gateOutAt, sealNo, weighmentKg, declaredKg, expectedPackages);
  }
...
abstract mixin class _$HubTaskCopyWith<$Res> implements $HubTaskCopyWith<$Res> {
  factory _$HubTaskCopyWith(_HubTask value, $Res Function(_HubTask) _then) =
      __$HubTaskCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$HubTaskCopyWithImpl<$Res> implements _$HubTaskCopyWith<$Res> {
...
mixin _$ScanItem {
  ...
  $ScanItemCopyWith<ScanItem> get copyWith =>
      _$ScanItemCopyWithImpl<ScanItem>(this as ScanItem, _$identity);
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.damaged, _this.damaged) ||
                other.damaged == _this.damaged) &&
            (identical(other.shortage, _this.shortage) ||
                other.shortage == _this.shortage) &&
  ...
  int get hashCode {
    final _this = this as ScanItem;
    return Object.hash(runtimeType, _this.code, _this.at, _this.damaged,
        _this.shortage, _this.photoPath);
  }
...
abstract mixin class $ScanItemCopyWith<$Res> {
  factory $ScanItemCopyWith(ScanItem value, $Res Function(ScanItem) _then) =
      _$ScanItemCopyWithImpl;
  @useResult
  $Res call(
      {String code,
      DateTime at,
...
/// @nodoc
class _$ScanItemCopyWithImpl<$Res> implements $ScanItemCopyWith<$Res> {
...
extension ScanItemPatterns on ScanItem {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ScanItem value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String code, DateTime at, bool damaged, bool shortage,
            String? photoPath)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ScanItem() when $default != null:
        return $default(_that.code, _that.at, _that.damaged, _that.shortage,
            _that.photoPath);
      case _:
        return orElse();
    }
...
class _ScanItem implements ScanItem {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ScanItemCopyWith<_ScanItem> get copyWith =>
      __$ScanItemCopyWithImpl<_ScanItem>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ScanItemToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ScanItemCopyWith<$Res>
    implements $ScanItemCopyWith<$Res> {
  factory _$ScanItemCopyWith(_ScanItem value, $Res Function(_ScanItem) _then) =
      __$ScanItemCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String code,
...
/// @nodoc
class __$ScanItemCopyWithImpl<$Res> implements _$ScanItemCopyWith<$Res> {
...
mixin _$Manifest {
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is Manifest &&
            (identical(other.id, _this.id) || other.id == _this.id) &&
            (identical(other.destHub, _this.destHub) ||
  ...
  int get hashCode {
    final _this = this as Manifest;
    return Object.hash(runtimeType, _this.id, _this.destHub,
        const DeepCollectionEquality().hash(_this.items), _this.createdAt);
  }
...
/// @nodoc
class _$ManifestCopyWithImpl<$Res> implements $ManifestCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(Manifest(
      id: null == id
          ...
          : id // ignore: cast_nullable_to_non_nullable
              as String,
      destHub: null == destHub
          ? _self.destHub
          : destHub // ignore: cast_nullable_to_non_nullable
              as String,
      items: null == items
          ? _self.items
...
extension ManifestPatterns on Manifest {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String destHub, List<ScanItem> items,
            DateTime createdAt)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _Manifest() when $default != null:
        return $default(_that.id, _that.destHub, _that.items, _that.createdAt);
      case _:
        return orElse();
    }
  }
...
class _Manifest implements Manifest {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _Manifest &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.destHub, destHub) || other.destHub == destHub) &&
  ...
  @override
  int get hashCode {
    return Object.hash(runtimeType, id, destHub,
...
/// @nodoc
class __$ManifestCopyWithImpl<$Res> implements _$ManifestCopyWith<$Res> {
