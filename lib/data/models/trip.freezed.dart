...
mixin _$TripStep {
  ...
  int get hashCode {
    final _this = this as TripStep;
    return Object.hash(runtimeType, _this.type, _this.at, _this.lat, _this.lng,
        _this.photoPath, _this.note);
  }
...
extension TripStepPatterns on TripStep {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(TripStepType type, DateTime at, double lat, double lng,
            String? photoPath, String? note)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _TripStep() when $default != null:
        return $default(_that.type, _that.at, _that.lat, _that.lng,
            _that.photoPath, _that.note);
      case _:
        return orElse();
    }
  }
...
mixin _$Trip {
  ...
  String get dropContact;
  String get dropPhone;
  double get dropLat;
  double get dropLng;
  double get distanceKm;
  int get freightAllowance;
  DateTime get pickupBy;
  String get vehicleReg;
  String get driverId;
  TripStatus get status;
  DateTime? get plannedEta;
  DateTime? get liveEta;
  List<TripStep> get steps;
  String? get lrNo;
  String? get ewayBillNo;
  PodStatus get podStatus;
  int get advanceGiven;
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.pickupAddress, _this.pickupAddress) ||
                other.pickupAddress == _this.pickupAddress) &&
            (identical(other.pickupContact, _this.pickupContact) ||
                other.pickupContact == _this.pickupContact) &&
            (identical(other.pickupPhone, _this.pickupPhone) ||
                other.pickupPhone == _this.pickupPhone) &&
            (identical(other.pickupLat, _this.pickupLat) ||
                other.pickupLat == _this.pickupLat) &&
            (identical(other.pickupLng, _this.pickupLng) ||
                other.pickupLng == _this.pickupLng) &&
            (identical(other.dropAddress, _this.dropAddress) ||
                other.dropAddress == _this.dropAddress) &&
            (identical(other.dropContact, _this.dropContact) ||
                other.dropContact == _this.dropContact) &&
            (identical(other.dropPhone, _this.dropPhone) ||
                other.dropPhone == _this.dropPhone) &&
            (identical(other.dropLat, _this.dropLat) ||
                other.dropLat == _this.dropLat) &&
            (identical(other.dropLng, _this.dropLng) ||
                other.dropLng == _this.dropLng) &&
            (identical(other.distanceKm, _this.distanceKm) ||
                other.distanceKm == _this.distanceKm) &&
            (identical(other.freightAllowance, _this.freightAllowance) ||
                other.freightAllowance == _this.freightAllowance) &&
            (identical(other.pickupBy, _this.pickupBy) ||
                other.pickupBy == _this.pickupBy) &&
            ...
            (identical(other.plannedEta, _this.plannedEta) ||
                other.plannedEta == _this.plannedEta) &&
            (identical(other.liveEta, _this.liveEta) ||
                other.liveEta == _this.liveEta) &&
            const DeepCollectionEquality().equals(other.steps, _this.steps) &&
            (identical(other.lrNo, _this.lrNo) || other.lrNo == _this.lrNo) &&
            (identical(other.ewayBillNo, _this.ewayBillNo) ||
                other.ewayBillNo == _this.ewayBillNo) &&
            (identical(other.podStatus, _this.podStatus) ||
                other.podStatus == _this.podStatus) &&
            (identical(other.advanceGiven, _this.advanceGiven) ||
                other.advanceGiven == _this.advanceGiven) &&
            (identical(other.rejectReason, _this.rejectReason) ||
                other.rejectReason == _this.rejectReason));
  }
  ...
  int get hashCode {
    ...
    return Object.hashAll([
      ...
      _this.plannedEta,
      _this.liveEta,
      const DeepCollectionEquality().hash(_this.steps),
      _this.lrNo,
      _this.ewayBillNo,
      _this.podStatus,
      _this.advanceGiven,
...
class _$TripCopyWithImpl<$Res> implements $TripCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? pickupPhone = null,
    Object? pickupLat = null,
    Object? pickupLng = null,
    Object? dropAddress = null,
    Object? dropContact = null,
    Object? dropPhone = null,
    Object? dropLat = null,
    Object? dropLng = null,
    Object? distanceKm = null,
    Object? freightAllowance = null,
    Object? pickupBy = null,
    Object? vehicleReg = null,
    Object? driverId = null,
    Object? status = null,
    Object? plannedEta = freezed,
    Object? liveEta = freezed,
    Object? steps = null,
    Object? lrNo = freezed,
    Object? ewayBillNo = freezed,
    Object? podStatus = null,
    Object? advanceGiven = null,
    ...
    return _then(Trip(
      ...
      dropAddress: null == dropAddress
          ...
          : dropAddress // ignore: cast_nullable_to_non_nullable
              as String,
      dropContact: null == dropContact
          ? _self.dropContact
          : dropContact // ignore: cast_nullable_to_non_nullable
              as String,
      dropPhone: null == dropPhone
          ? _self.dropPhone
          : dropPhone // ignore: cast_nullable_to_non_nullable
              as String,
      ...
      distanceKm: null == distanceKm
          ...
          : distanceKm // ignore: cast_nullable_to_non_nullable
              as double,
      freightAllowance: null == freightAllowance
          ? _self.freightAllowance
          : freightAllowance // ignore: cast_nullable_to_non_nullable
              as int,
      pickupBy: null == pickupBy
          ? _self.pickupBy
          : pickupBy // ignore: cast_nullable_to_non_nullable
              as DateTime,
      ...
      status: null == status
          ...
          : status // ignore: cast_nullable_to_non_nullable
              as TripStatus,
      plannedEta: freezed == plannedEta
          ? _self.plannedEta
          : plannedEta // ignore: cast_nullable_to_non_nullable
              as DateTime?,
      liveEta: freezed == liveEta
          ? _self.liveEta
          : liveEta // ignore: cast_nullable_to_non_nullable
              as DateTime?,
      steps: null == steps
          ? _self.steps
      ...
      lrNo: freezed == lrNo
          ...
          : lrNo // ignore: cast_nullable_to_non_nullable
              as String?,
      ewayBillNo: freezed == ewayBillNo
          ? _self.ewayBillNo
          : ewayBillNo // ignore: cast_nullable_to_non_nullable
              as String?,
      podStatus: null == podStatus
          ? _self.podStatus
          : podStatus // ignore: cast_nullable_to_non_nullable
              as PodStatus,
      advanceGiven: null == advanceGiven
          ? _self.advanceGiven
          : advanceGiven // ignore: cast_nullable_to_non_nullable
              as int,
...
class _Trip implements Trip {
  const _Trip(
      ...
      required this.freightAllowance,
      ...
      this.plannedEta,
      this.liveEta,
      List<TripStep> steps = const [],
      this.lrNo,
      this.ewayBillNo,
      this.podStatus = PodStatus.pending,
      this.advanceGiven = 0,
      this.rejectReason})
      : _steps = steps;
  ...
  @override
  @JsonKey()
  final PodStatus podStatus;
  @override
  @JsonKey()
  final int advanceGiven;
  @override
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.pickupPhone, pickupPhone) ||
                other.pickupPhone == pickupPhone) &&
            ...
            (identical(other.dropContact, dropContact) ||
                other.dropContact == dropContact) &&
            (identical(other.dropPhone, dropPhone) ||
                other.dropPhone == dropPhone) &&
            (identical(other.dropLat, dropLat) || other.dropLat == dropLat) &&
            (identical(other.dropLng, dropLng) || other.dropLng == dropLng) &&
            (identical(other.distanceKm, distanceKm) ||
                other.distanceKm == distanceKm) &&
            (identical(other.freightAllowance, freightAllowance) ||
                other.freightAllowance == freightAllowance) &&
            (identical(other.pickupBy, pickupBy) ||
            ...
            (identical(other.plannedEta, plannedEta) ||
                other.plannedEta == plannedEta) &&
            (identical(other.liveEta, liveEta) || other.liveEta == liveEta) &&
            const DeepCollectionEquality().equals(other.steps, _steps) &&
            (identical(other.lrNo, lrNo) || other.lrNo == lrNo) &&
            (identical(other.ewayBillNo, ewayBillNo) ||
                other.ewayBillNo == ewayBillNo) &&
            (identical(other.podStatus, podStatus) ||
                other.podStatus == podStatus) &&
            (identical(other.advanceGiven, advanceGiven) ||
                other.advanceGiven == advanceGiven) &&
