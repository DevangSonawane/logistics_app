...
final class OrdersByStatusProvider extends $FunctionalProvider<
...
final class AllOpsOrdersProvider extends $FunctionalProvider<
        AsyncValue<List<Order>>, List<Order>, FutureOr<List<Order>>>
    with $FutureModifier<List<Order>>, $FutureProvider<List<Order>> {
...
final class RankedVehiclesProvider extends $FunctionalProvider<
...
final class RankedVehiclesFamily extends $Family
  ...
  RankedVehiclesProvider call({
    ...
    required String vehicleType,
      ...
      RankedVehiclesProvider._(argument: (
        weightKg: weightKg,
...
final class RosterDriversProvider extends $FunctionalProvider<
        AsyncValue<List<Driver>>, List<Driver>, FutureOr<List<Driver>>>
...
final class DriverTripLoadProvider extends $FunctionalProvider<
...
final class OpsLiveTripsProvider extends $FunctionalProvider<
...
final class ExceptionsFeedProvider extends $FunctionalProvider<
...
final class MarketVehiclesProvider extends $FunctionalProvider<
